...
PapaLevel is a documentation-first MVP planning workspace.

- Current state: product planning documents, research notes, and backlog tickets are present.
- Current focus: connect `research -> problem definition -> PRD -> UX draft -> tech direction -> task breakdown -> QA`.
...
This repository does **not** yet contain a production application codebase. The primary deliverables here are Markdown artifacts.
